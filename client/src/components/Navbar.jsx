            ...
            <header className='hidden lg:flex max-w-[1440px] justify-between items-center m-auto'>
                <div className='flex justify-between items-center'>
                    ...
                    <ul className='w-[350px] flex items-center justify-between text-gray-400 text-[15px] font-semibold'>
                        <li className='font-bold text-2xl text-gray-900'><Link to={'/'}>Ticketly</Link></li>
                ...
                <div>
                    <Link to={'/register'} className='bg-purple text-white p-btn mr-5'>Sign Up</Link>
                    <Link to={'/login'} className='bg-light text-dark p-btn'>Login</Link>
                </div>
            </header>
            <MobileNavbar />
        </nav>
