        ...
        <section className='w-full h-[120vh] overflow-hidden'>
            <div className='w-full max-w-[1440px] m-auto flex justify-between items-center p-5 lg:-20 h-full'>
                <div className='hidden lg:flex w-[45%] relative h-[70%] max-h-[500px]'>
                    <img className='rounded-md fill' src={'/register-image.png'} alt='Image of people purchasing tickets' />
                </div>
                <form className='flex flex-col justify-center items-center w-full lg:w-[calc(100%-45%)] space-y-6'>
                    <div className='flex justify-center items-center'>
                        ...
                        <Link to={'/'} className='font-bold text-3xl text-gray-900'>Ticketly</Link>
                    </div>
                    <div>
                        <h2 className='text-dark font-bold text-[30px]'>Create an account</h2>
                        <p className='text-gray-500'>Alreayd have an account? <Link href={'/auth/login'} className='text-purple'>Login</Link></p>
                    </div>
                    <input type="text" placeholder='Full Name' className='p-3 focus:outline-none w-full lg:w-1/2 bg-gray-300 rounded-lg' />
                    <input type="tel" placeholder='Phone Number' className='p-3 focus:outline-none w-full lg:w-1/2 bg-gray-300 rounded-lg' />
                    <input type="email" placeholder='Email Address' className='p-3 focus:outline-none w-full lg:w-1/2 bg-gray-300 rounded-lg' />
                    <div className='flex justify-between items-center w-full lg:w-1/2 bg-gray-300 rounded-lg'>
                        <input type={showPassword ? "text" : "password"} placeholder='Password' className='w-full p-3 focus:outline-none' />
                        {
                    ...
                    <button className='w-full lg:w-1/2 bg-purple rounded-md text-white font-semibold p-3 hover:cursor-pointer shadow-md'>Sign Up</button>
                    ...
                    <button className='flex justify-center items-center w-full lg:w-1/2 bg-white rounded-md text-gray-500 shadow-md border-1 border-gray-400 font-semibold p-3 hover:cursor-pointer'><img src={'/google_logo.png'} width={25} height={25} alt='Google logo' priority className='mr-3' />Continue with google</button>
                </form>
            </div>
        </section>
    )
